...
export class MoviesPage {
    ...
    constructor(public platform: Platform, private tts: TextToSpeech, private iab: InAppBrowser, private sharingVar: SocialSharing, public rData: CricNewsProvider, public navCtrl: NavController, public navParams: NavParams, public loadingCtrl: LoadingController) {
       ...
       this.platform.ready().then(() => {
        if(this.j==0){
            ...
            if(i==0){   
                ...
                textOrOptions={
                text:"Good Morning. Welcome to G News. Section Movies. Headlines. "+this.title+". Detailed News. "+this.desc,
                locale:"en-US",
                rate:0.8
            }
